function startButton () {
  ...
  if (occupation == "MISSION CONTROL") {
    ...
    if (missfateone == "CHECK THE SHUTTLE") {
      let missionend = prompt("You find an issue with the shuttle, but it seems fairly minor. If you report it, the shuttle will be delayed. Will you REPORT the issue or IGNORE it?");
